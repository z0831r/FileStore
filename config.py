...
MESSAGES = {
    ...
    "FSUB": "<b><blockquote>🚨 需关注频道 ×</blockquote>\n  您的文件已准备就绪 ‼️\n\n检测到您尚未关注我们的频道，为了防止滥用，请点击下方按钮关注，然后点击“刷新重试”即可获取文件。</b>",
    ...
    "SHORT_MSG": "<b>📊 嘿 {first}, \n\n‼️ 获取您的文件链接 ‼️\n\n ⌯ 链接已生成，请点击下方按钮打开..</b>",
    "START_PHOTO": "[url=https://ibb.co/GQpshWjr][img]https://i.ibb.co/YBQDrcGV/photo-2026-01-13-19-08-13.jpg[/img][/url]",
